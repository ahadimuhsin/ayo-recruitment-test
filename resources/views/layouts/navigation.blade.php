<ul>
    ...
    <li class="nav-item @if(request()->routeIs('teams.index')) active @endif">
    ...
    <li class="nav-item @if(request()->routeIs('matches.index')) active @endif">
        <a href="{{ route('matches.index') }}">
            ...
            <span class="text">{{ __('Matches') }}</span>
        </a>
    </li>
